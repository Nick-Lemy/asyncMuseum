  ...
  const exhibits = [
    {
      id: 1,
      name: "La Joconde",
      info: "Portrait de la Renaissance",
    ...
    },
    {
      id: 2,
      name: "Le Cri",
      info: "Chef-d'œuvre expressionniste",
      auteur: "Edvard Munch",
      image:
    ...
    },
    {
      ...
      info: "Art de l'Âge d'or néerlandais",
    ...
    },
    {
      ...
      info: "Montres molles surréalistes",
